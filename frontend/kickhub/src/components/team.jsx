...
import Image from "../../public/team.png";
...
const team = (props) => {
  return (
      ...
      <div className="cardfield relavive ">
        <div className="">
        <img className="w-[138px] h-[100px]" src={Image} alt="" />
      </div>
      ...
      <div>
       <button className="bg-green-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded  mt-4 text-center absolute right-20 rounded-xl">
       <h1>ดูรายละเอียด</h1>
       </button>
      </div>
      </div>
