    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        <div
          ...
          aria-hidden="true"
        />
        <div className="relative bg-white rounded-lg shadow-lg w-[80rem] max-w-[90%] max-h-[90%] overflow-auto">
          <button
            type="button"
          ...
          <div className="flex items-center justify-center">
            <div className="bg-green-600 w-[40rem] h-[40rem] rounded-s-lg flex items-center justify-center">
              <img src={KHlogo} alt="Login Image" className="size-full"/>
            </div>
            <div className="flex flex-col items-center justify-center bg-gray-100 w-[40rem] h-[40rem] rounded-e-lg">
              <h1 className="flex justify-center text-[4rem] font-black text-blue-600 mt-10">
                WELCOME
              </h1>
              <div className="flex flex-col mt-10">
                <form className="bg-white flex flex-col gap-1 p-3 rounded-lg">
                  <div>
                    <label className="text-black text-[0.9rem] font-bold">
                      Email
                    </label>
                  </div>
                  <div className="flex items-center justify-center border-1 border-gray-300 w-[16rem] h-[2rem] px-2 rounded-md gap-2">
                    <svg
                      height="20"
                      viewBox="0 0 32 32"
                      width="20"
