    ...
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-[24.5rem] h-[10rem]">
        <div className="absolute top-5 left-36 z-10">
          <form className="flex items-center bg-white rounded-full shadow-sm px-3 py-2 w-[200px] transition-all duration-300 focus-within:ring-2 focus-within:ring-blue-500">
            ...
            <button
              type="reset"
              className="text-gray-400 hover:text-red-500 transition-opacity opacity-0 peer-placeholder-shown:opacity-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
...
{/* รูป canva */}
      ...
      {/* BODY */}
      <div className="relative bottom-0 bg-[#F2F2F7] rounded-t-2xl h-[28.5rem] w-[24.5rem] p-5 overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          {fields.map((field) => (
            ...
            >
              ...
              {/* Features */}
              <div className="flex flex-wrap justify-end gap-2 px-4 mt-2">
              ...
              <div className="flex justify-end px-4 py-3">
                <button className="bg-green-500 hover:bg-green-600 text-white font-semibold px-4 py-2 rounded-full text-sm transition">
                  ดูรายละเอียด →
                </button>
              </div>
            </div>
